...
$(".LinksNav").click(function () {
  ...
  if (leftNav == "0px") {
    $(".outerBox").animate({ left: `${innerBoxWidth}px` }, 2000);
  } else {
    $(".outerBox").animate({ left: `0px` }, 2000);
  }
});
...
$('.LinksNav').click(function(){
    $(".innerBox .item1").animate({ opacity: "1",paddingTop: "25px"},1100),
    $(".innerBox .item2").animate({ opacity: "1",paddingTop: "25px"},1200),
    $(".innerBox .item3").animate({ opacity: "1",paddingTop: "25px"},1300),
    $(".innerBox .item4").animate({ opacity: "1",paddingTop: "25px"},1400),
    $(".innerBox .item5").animate({ opacity: "1",paddingTop: "25px"},1500),
